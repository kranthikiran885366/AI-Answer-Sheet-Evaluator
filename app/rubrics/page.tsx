        ...
        <SidebarInset className="flex-1">
          <header className="sticky top-0 z-40 border-b border-green-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
            <div className="flex h-16 items-center gap-4 px-6">
              ...
              <h1 className="text-lg font-semibold text-green-900">Rubric Management</h1>
          ...
          <main className="flex-1 overflow-auto">
            <div className="container mx-auto p-6 space-y-8">
              ...
              <div className="space-y-2">
                <h2 className="text-3xl font-bold text-green-900">Rubric Management</h2>
                <p className="text-green-700">Create and manage custom evaluation rubrics</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="border-green-200 bg-gradient-to-br from-green-50 to-white">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-green-900">Total Rubrics</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-2xl font-bold text-green-700">28</p>
                    <p className="text-xs text-green-600 mt-1">Created & active</p>
                  </CardContent>
                </Card>

                <Card className="border-green-200 bg-gradient-to-br from-blue-50 to-white">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-blue-900">In Use</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-2xl font-bold text-blue-700">15</p>
                    <p className="text-xs text-blue-600 mt-1">Currently used</p>
                  </CardContent>
                </Card>

                <Card className="border-green-200 bg-gradient-to-br from-purple-50 to-white">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-purple-900">Evaluations</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-2xl font-bold text-purple-700">1,247</p>
                    <p className="text-xs text-purple-600 mt-1">Using rubrics</p>
                  </CardContent>
                </Card>
              </div>

              {/* Rubric Management Component */}
